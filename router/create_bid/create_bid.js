...
import pkg_revised from '../../../BidHandling_CalculatePrice-1/execute.js'
...
const eligible_audit_EmptyBid = path.resolve('../', 'CMC_Project_EliglbleAudit_Converted/AutoBid/EmptyBid') //적격심사 입찰서 작성 EmptyBid 폴더 위치
